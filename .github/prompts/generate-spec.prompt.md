...
2. Lee el stack: `.github/instructions/backend.instructions.md` (Spring Boot 4 / Java 21).
...
- Modelos de datos (JPA Entities + BaseDatos.sql)
- Endpoints de API con request/response y errores
- Plan de pruebas para backend y QA