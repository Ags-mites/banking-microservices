...
- Generar la spec en [[specs/<nombre-feature>.spec.md]].

## Proceso (ejecutar en orden)

1. **Verifica si hay requerimiento** en [[requirements/<feature>.md]]
2. **Lee el tech stack:** [[instructions/backend.instructions.md]]
3. **Lee la arquitectura:** [[instructions/backend.instructions.md]]
4. **Lee el diccionario de dominio:** [[copilot-instructions.md]]
5. **Lee la plantilla:** [[skills/generate-spec/SKILL.md#spec-template.md]] — úsala EXACTAMENTE
...
8. **Guarda** en [[specs/<nombre-feature-kebab-case>.spec.md]]
...
- El archivo de spec debe estar en [[specs/]].
