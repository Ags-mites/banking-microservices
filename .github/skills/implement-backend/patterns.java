 ...
 * Spring Boot 4 / Java 21 con Arquitectura Hexagonal
 * Este archivo es referencia para que el agente genere código consistente.
 */
...
public interface FeatureMapper {
    ...
    @Mapping(target = "updatedAt", ignore = true)
    @Mapping(target = "version", ignore = true)
    void updateEntityFromDto(UpdateFeatureDto dto, @Context Feature entity);
}
